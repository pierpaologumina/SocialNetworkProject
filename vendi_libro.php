...
<div class="row">
    <div class="col-sm-12">
        <div class="well">
            <center><h1 style="color: white">Vendita libro</h1>
...
<div class="row">
    <div class="col-sm-12">
        <div class="main-content">
            ...
            <br>
            <div class="l-part">
                <form action="inserisci_libro.php?idd=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="material-icons">book</i></span>
                        <input type="number" min="1" class="form-control" placeholder="Edizione" name="edizione" required="required">
                    </div><br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="material-icons">assessment</i></span>
                        <select class="form-control" name="condizione" required="required">
                            <option disabled>Seleziona la condizione del libro</option>
                            <option>Pessime</option>
                            <option>Discrete</option>
                            <option>Ottime</option>
                            <option>Quasi Nuovo</option>
                        </select>
                    </div><br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="material-icons">attach_money</i></span>
                        <input type="number" min="1" class="form-control" placeholder="Prezzo in €" name="prezzo" required="required">
                    </div><br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control" placeholder="Inserisci un tuo contatto telefonico" name="telefono" required="required">
                    </div><br>
                    <div class="input-group">
                    ...
                    <center><button id="inserisci" class="btn btn-info btn-lg" name="inserisci_libro" type="submit">Metti in Vendita</button></center>
